    ...
    <body>
		<div id="corps">
			...
			<form action="#" method="POST">
				...
				<?php
					echo displayBudget($bdd, getDateMin(), getDateMax(), $_SESSION['idProjet']);
					//echo displayTabByName($bdd, 'budget', $_SESSION['idProjet']);
				?>
			</form>
			<?php
				//echo "<h4>année la plus petite : ".getDateMin()."</h4>";
				//echo "<h4>année la plus grande : ".getDateMax()."</h4>";
			?>
		</div>
    </body>
</html>